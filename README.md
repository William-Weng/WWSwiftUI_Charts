...
https://github.com/user-attachments/assets/4891a0e9-ec68-4507-a896-770b19207601

### [Installation with Swift Package Manager](https://medium.com/彼得潘的-swift-ios-app-開發問題解答集/使用-spm-安裝第三方套件-xcode-11-新功能-2c4ffcf85b4b)
```bash
dependencies: [
    .package(url: "https://github.com/William-Weng/WWSwiftUI_Charts.git", .upToNextMajor(from: "1.2.10"))
]
```
...
|LineMark(model:lineWidth:lineColors:useAnnotation:unit:orientation:interpolationMethod:)|初始化 (折線圖)|
|PointMark(model:symbolSize:pointColors:useAnnotation:displayMode)|初始化 (散點圖)|
